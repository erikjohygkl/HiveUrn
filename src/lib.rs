...
#[derive(Debug)]
pub struct HiveUrnProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HiveUrnProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HiveUrn processing");
    
    let mut processor = HiveUrnProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HiveUrnProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HiveUrnProcessor::new(false);
